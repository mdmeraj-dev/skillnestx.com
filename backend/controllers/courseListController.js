...
// Database Indexing: Ensure indexes are created for frequently queried fields
Course.collection.createIndex({ title: 1, category: 1 }); // Indexing for faster searches
